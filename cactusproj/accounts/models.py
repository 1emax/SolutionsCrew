...
class Profile(models.Model):
    ...
    slug = models.SlugField(unique=True, max_length=100, help_text=_("automatically generated, don't change manually !"))
    ...
    def get_avatar_sm(self):
        if self.profile_image:
            ...
            return '{}accounts/default/default-avatar_sm.jpeg'.format(settings.STATIC_URL)
    ...
    def get_avatar_xs(self):
        if self.profile_image:
            ...
            return '{}accounts/default/default-avatar_xs.jpeg'.format(settings.STATIC_URL)
