...
from cactusproj.registration.forms import UserProfileRegistrationForm
...
class UserRegistrationView(RegistrationView):
    ...
    def register(self, form_class):
        new_user = super(UserRegistrationView, self).register(form_class)
    ...
    def render_to_response(self, context, **response_kwargs):
        response = super(UserRegistrationView, self).render_to_response(context, **response_kwargs)
        return response
